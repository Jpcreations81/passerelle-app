...
import FichePresenceRelais from './pages/FichePresenceRelais'
import './App.css'
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/fiche-presence-relais" element={session ? <FichePresenceRelais profile={profile} /> : <Navigate to="/login" />} />
