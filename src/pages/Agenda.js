        ...
        evt.enfant_ids.forEach((enfantId, idx) => {
          ...
          if (evt.categorie === 'relais') {
            if (evt.af_id === profile?.id) {
              ...
              if (afRelais) titrePOV = 'Relais famille ' + afRelais.nom + (enfantPrenom ? ' — ' + enfantPrenom : '')
              ...
              if (afPrincipal) titrePOV = 'Relais famille ' + afPrincipal.nom + (enfantPrenom ? ' — ' + enfantPrenom : '')
              else titrePOV = 'Relais famille principale' + (enfantPrenom ? ' — ' + enfantPrenom : '')
            }
          }
          expanded.push({
            ...evt,
