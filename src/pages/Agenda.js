              ...
              {newEvt.categorie === 'relais' && (
                <div className="form-group col-span-2" style={{ background:'#e0f2fe', borderRadius:9, padding:12, border:'1px solid #bae6fd' }}>
                  ...
                  {newEvt.relais_type === 'af' && (() => {
                    // Trouver les AF qui ont déjà accueilli les enfants sélectionnés en relais
                    ...
                    const [rechercheAF, setRechercheAF] = React.useState('')
                    const afFiltres = rechercheAF.length > 1
                      ? collegues.filter(c => (c.role === 'af' || !c.role) &&
                          `${c.prenom} ${c.nom}`.toLowerCase().includes(rechercheAF.toLowerCase()))
                      : []
                    return (
                      <div>
                        <label className="form-label">Famille AF relais</label>
                        {/* Relais habituels */}
                        {relaisHabituels.length > 0 && (
                        ...
                        <div style={{ position: 'relative' }}>
                          <input className="form-control"
                            ...
                            value={rechercheAF || (newEvt.relais_structure_id && !relaisHabituels.find(r => r.id === newEvt.relais_structure_id) ? newEvt.relais_nom_libre : '')}
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ background:'#eef1f8', borderRadius:9, padding:14, marginBottom:14, lineHeight:2, fontSize:12 }}>
                      ...
                      {selectedEvt.categorie === 'relais' && !selectedEvt.relais_structure_id && selectedEvt.relais_nom_libre && (
