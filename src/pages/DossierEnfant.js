...
export default function DossierEnfant({ profile }) {
  ...
  function openParentModal(type) {
    ...
    if (parentActuel) {
      ...
      setEditParent({ nom:'', prenom:'', date_naissance:'', telephone:'', telephone2:'', adresse:'', code_postal:'', ville:'', email:'', situation_pro:'', droits_parentaux:'', droit_visite:'', notes:'' })
    }
                      ...
                      {masque ? (
                        ...
                        <div style={{ display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:16 }}>
                          {[
                            ...
                            { label:'Date de naissance', v: data.date_naissance ? (() => { const [y,m,d] = data.date_naissance.split('-'); return new Date(+y,+m-1,+d).toLocaleDateString('fr-FR') })() : '' },
