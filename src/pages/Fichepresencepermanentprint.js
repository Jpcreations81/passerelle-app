// FichePresencePermanentPrint.js — v2026-05-22a — impression fiche permanente + couleurs + titre PDF
          ...
          <table style={{ width:'100%', borderCollapse:'collapse', border:'1px solid #333' }}>
            ...
            <tbody>
              {days.map((d, i) => {
                ...
                const isBlue = (dim || fe) && !isRelais
                const rowBg = isRelais ? '#fef9c3' : isBlue ? '#dbeafe' : '#fff'
                return (
